...
I1=imread('C:\Users\manan\Desktop\c.jfif');
% im2 double converts image to double precision
I = im2double(imread('C:\Users\manan\Desktop\c.jfif')); 
figure, imshow(I)
title('Input Image');
...
% Here imfilter is fultering accoridung to convolution and the input values are circular.
